  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-theme-primary mb-4">Terms of Service</h1>
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-theme-primary mb-4">2. Use License</h2>
          <p className="text-theme-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-theme-primary mb-4">3. Product Information</h2>
          <p className="text-theme-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-theme-primary mb-4">4. Pricing and Payment</h2>
          <p className="text-theme-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-theme-primary mb-4">5. Shipping and Delivery</h2>
          <p className="text-theme-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-theme-primary mb-4">6. Returns and Refunds</h2>
          <p className="text-theme-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-theme-primary mb-4">7. User Accounts</h2>
          <p className="text-theme-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-theme-primary mb-4">8. Prohibited Uses</h2>
          <p className="text-theme-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-theme-primary mb-4">9. Disclaimer</h2>
          <p className="text-theme-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-theme-primary mb-4">10. Limitations</h2>
          <p className="text-theme-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-theme-primary mb-4">11. Revisions and Errata</h2>
          <p className="text-theme-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-theme-primary mb-4">12. Links</h2>
          <p className="text-theme-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-theme-primary mb-4">13. Modifications</h2>
          <p className="text-theme-secondary mb-4">
