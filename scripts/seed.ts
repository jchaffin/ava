...
const products = [
  {
    ...
    price: 49.99,
    image: 'products/7006/hydserum_main.jpg',
  ...
  },
  {
    ...
    price: 59.99,
    image: 'products/7007/vitcserum_main.jpg',
    sizes: '(max-width: 640px) 100vw, (max-width: 768px) 50vw, (max-width: 1024px) 33vw, 25vw',
    stock: 120,
    featured: true,
  },
  {
    ...
    price: 69.99,
    image: 'products/7008/collagenserum_main.jpg',
    sizes: '(max-width: 640px) 100vw, (max-width: 768px) 50vw, (max-width: 1024px) 33vw, 25vw',
    stock: 100,
    featured: true,
  },
  {
    ...
    price: 79.99,
    image: 'products/7009/antiageserum_main.jpg',
    sizes: '(max-width: 640px) 100vw, (max-width: 768px) 50vw, (max-width: 1024px) 33vw, 25vw',
    stock: 80,
    featured: true,
  },
  {
    ...
    price: 54.99,
    image: 'products/700a/brserum_main.jpg',
    sizes: '(max-width: 640px) 100vw, (max-width: 768px) 50vw, (max-width: 1024px) 33vw, 25vw',
    stock: 110,
    featured: false,
  },
  {
    ...
    price: 44.99,
    image: 'products/700b/soothserum_main.jpg',
    sizes: '(max-width: 640px) 100vw, (max-width: 768px) 50vw, (max-width: 1024px) 33vw, 25vw',
    stock: 90,
    featured: false,
  },
  {
    ...
    price: 64.99,
    image: 'products/700c/iserum_main.jpg',
    sizes: '(max-width: 640px) 100vw, (max-width: 768px) 50vw, (max-width: 1024px) 33vw, 25vw',
    stock: 75,
    featured: false,
  },
  {
    ...
    price: 39.99,
    image: 'products/700d/hyserum_main.jpg',
    sizes: '(max-width: 640px) 100vw, (max-width: 768px) 50vw, (max-width: 1024px) 33vw, 25vw',
    stock: 130,
    featured: false,
  },
